...
# EXPECTED_VERSION="${AGENTM5N_VERSION:-1.3.7}"
# EXPECTED_BUILD="${AGENTM5N_BUILD_NUMBER:-37}"
EXPECTED_VERSION="${AGENTM5N_VERSION:-1.3.8}"
EXPECTED_BUILD="${AGENTM5N_BUILD_NUMBER:-38}"
